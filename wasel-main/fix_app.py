...
text = text.replace(
'''      <Route path="/shared-cart/:token" element={<SharedCartPay />} />
      <Route path="/shared-cart" element={<SharedCartPay />} />
      <Route path="/wasel-app/shared-cart/:token" element={<SharedCartPay />} />
      <Route path="/wasel-app/shared-cart" element={<SharedCartPay />} />''',
