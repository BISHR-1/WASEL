...
export default function AnimatedLoginCard({ 
  ...
  return (
    <div className="w-full min-h-screen flex items-center justify-center bg-[#F9FAF8] p-4">
      <motion.div
      ...
      >
        ...
        <div className="relative bg-white rounded-3xl overflow-hidden shadow-2xl border-2 border-[#E5E7EB]">
          ...
          {/* Top Section - Mascot */}
          <div className="relative bg-gradient-to-br from-[#F9FAF8] to-[#E5E7EB]/30 pt-12 pb-8 px-8">
            {/* Decorative circles */}
            <div className="absolute top-4 left-4 w-20 h-20 bg-[#1F7A63]/20 rounded-full blur-2xl" />
            <div className="absolute bottom-4 right-4 w-32 h-32 bg-[#2FA36B]/30 rounded-full blur-3xl" />
            ...
            >
              <div className="relative">
                {/* Glow effect */}
                <div className="absolute inset-0 bg-[#1F7A63]/20 rounded-full blur-xl scale-110" />
              ...
              <form onSubmit={onSubmit} className="space-y-4">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="w-full pr-12 bg-[#F9FAF8]/50 border-2 border-[#E5E7EB] h-14 text-lg rounded-xl focus:ring-2 focus:ring-[#1F7A63] focus:border-[#1F7A63] transition-all text-[#1F2933] placeholder:text-[#1F7A63]/60"
                    required
                    disabled={loading}
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="w-full pr-12 pl-12 bg-[#F9FAF8]/50 border-2 border-[#E5E7EB] h-14 text-lg rounded-xl focus:ring-2 focus:ring-[#1F7A63] focus:border-[#1F7A63] transition-all text-[#1F2933] placeholder:text-[#1F7A63]/60"
                    required
                    disabled={loading}
                    dir={language === 'ar' ? 'rtl' : 'ltr'}
                    minLength={6}
                ...
                >
                  {language === 'ar' ? 'لدي حساب بالفعل؟ تسجيل الدخول' : 'Already have an account? Login'}
                </button>
              </form>
            </motion.div>
          </div>
