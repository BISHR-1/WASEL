...
export default function AdminLogin() {
  ...
  const [mode, setMode] = useState('role'); // 'role', 'register', 'login'
  ...
  const roles = [
    {
      ...
      name_ar: 'المشرف',
      description: 'إدارة الطلبات والموصلين',
      icon: '👨‍💼',
    ...
    },
    {
      ...
      name_ar: 'موصل',
      description: 'استقبال الطلبات وتنفيذها',
      icon: '🚗',
    ...
    },
    {
      ...
      name_ar: 'مورد',
      description: 'إدارة المنتجات والمستودع',
      icon: '📦',
      ...
      >
        ...
        >
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <h1 className="text-3xl font-bold text-white">واصل</h1>
          </div>
