...
const steps = [
  {
    ...
    description: 'تتصفح المتاجر والمطاعم المتاحة في درعا وتختار المنتجات أو الوجبات التي تريد إرسالها لعائلتك. يمكنك اختيار من أقسام متعددة تشمل المطاعم والسوبرماركت والحلويات والإلكترونيات والهدايا والباقات الجاهزة. بعد الاختيار، تدخل بيانات المرسل والمستلم الضرورية فقط — اسم المستلم ورقم هاتفه وعنوانه في درعا — لضمان التوصيل بدقة وسرعة.',
    color: 'bg-[#52B788]'
  },
  {
    number: '2️⃣',
    ...
    description: 'نوفر عدة طرق دفع مرنة تناسب المغتربين: PayPal للدفع الإلكتروني الآمن من أي مكان في العالم، أو التواصل عبر واتساب لترتيب الدفع يدويًا. في حالة السلة المشتركة، يمكن لعدة أشخاص المساهمة في نفس الطلب — كل شخص يسجل دخوله ويدفع حصته بأمان من الرابط المشترك. رسوم التوصيل تظهر بوضوح قبل الدفع دون أي رسوم مخفية.',
    color: 'bg-[#1B4332]'
  },
  {
    number: '3️⃣',
    ...
    description: 'بمجرد إنشاء الطلب، يظهر في لوحة "طلباتي" مع حالة محدثة لحظيًا. نرسل إشعارات فورية عند كل تغيير في حالة الطلب: تم القبول، قيد التجهيز، خرج للتوصيل، تم التسليم. يتم إشعار فريق الإشراف المحلي فورًا لتسريع المعالجة. يمكنك أيضًا التواصل مع فريق الدعم في أي وقت عبر واتساب للاستفسار عن طلبك.',
    color: 'bg-[#2D6A4F]'
  },
  {
    number: '4️⃣',
    ...
    description: 'يُنفذ الطلب من قبل فريقنا المحلي في درعا الذين يعرفون المنطقة جيدًا. يتم شراء المنتجات من المتاجر المحلية وتجهيزها بعناية ثم توصيلها إلى باب منزل المستلم. عند التسليم، يتم توثيق العملية بصورة تُرسل إليك كإثبات وصول. متوسط زمن التوصيل 24-48 ساعة للطلبات العادية داخل مدينة درعا.',
    color: 'bg-[#40916C]'
  }
];
