-- =====================================================
-- COMPATIBLE ORDER CREATE RPC V2 (DYNAMIC)
-- Migration: 013_create_compatible_order_rpc_v2.sql
-- Purpose: Robust order insert across mixed orders schemas using dynamic SQL
-- =====================================================
