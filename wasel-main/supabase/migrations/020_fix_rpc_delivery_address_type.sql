-- =====================================================
-- FIX: create_compatible_order_v2 delivery_address type handling
-- Migration: 020_fix_rpc_delivery_address_type.sql
-- Problem: Some deployments have orders.delivery_address as json/jsonb.
--          RPC was always sending plain text, causing:
--          22P02 invalid input syntax for type json (Token "حي" is invalid)
-- =====================================================
